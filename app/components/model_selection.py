...
def model_selection_interface() -> Dict[str, Any]:
    ...
    with st.expander("⚙️ Advanced Settings"):
        batch_size = st.number_input("Batch Size:", min_value=1, max_value=100, value=16)
        enable_ood = st.checkbox("Enable Novel Detection", value=True, help="Detect unknown/novel sequences")
