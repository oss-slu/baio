...
from components.status_display import update_processing_status, show_progress_bar


def run_classification_pipeline(sequences: List[Tuple[str, str]], source: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        with status_container:
            st.success(f"✅ Classification complete! Processed {len(sequences)} sequences in {results['processing_time']:.1f}s")
